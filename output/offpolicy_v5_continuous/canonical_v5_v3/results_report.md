...
- Causal analytic teacher benchmark: 7.215991% a-d and 7.227750% e-h. This is not an RL result.
- Post-RL network captures 87.17% of the teacher's a-d primary savings.
...
- Causal analytic teacher benchmark: 15.715358% a-d and 16.361134% e-h. This is not an RL result.
- Post-RL network captures 89.09% of the teacher's a-d primary savings.
