...
**Protocol:** {{CANONICAL_V4R:PROTOCOL_ID}}
...
**Metric-replay checkpoint recovery SHA-256:** {{CANONICAL_V4R:CHECKPOINT_RECOVERY_SHA256}}
...
Validation uncertainty: {{CANONICAL_V4R:VALIDATION_DAY_BOOTSTRAP}}.

Test uncertainty: {{CANONICAL_V4R:TEST_DAY_BOOTSTRAP}} and
{{CANONICAL_V4R:TEST_MONTH_BOOTSTRAP}}.
