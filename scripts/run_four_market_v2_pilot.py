...
arguments. Results go to ``output/four_market_joint_v3/pilot/<tag>/`` and checkpoints
to ``models/four_market_joint_v3/pilot/<tag>/``, so campaign directories are never
